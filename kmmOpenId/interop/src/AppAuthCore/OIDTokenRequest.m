...
- (instancetype)initWithConfiguration:(nonnull OIDServiceConfiguration
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    ...
    NSString *
    refreshToken = [aDecoder decodeObjectOfClass:[NSString class] forKey:kRefreshTokenKey];
    NSString *
