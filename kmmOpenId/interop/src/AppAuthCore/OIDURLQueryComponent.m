...
- (nullable instancetype)initWithURL:(NSURL *)URL {
    ...
    if (self) {
        ...
        for (NSString *queryPart in queryParts) {
            ...
            NSString *value = [queryPart substringFromIndex:equalsRange.location +
                                                            equalsRange.length];
...
<NSString *, NSObject <NSCopying> *> *)dictionaryValue {
    // This method will flatten arrays in our @c _parameters' values if only one value exists.
    NSMutableDictionary < NSString * ,
            NSObject < NSCopying > * > *values = [NSMutableDictionary dictionary];
...
<NSString *> *)valuesForParameter:(NSString *)parameter {
