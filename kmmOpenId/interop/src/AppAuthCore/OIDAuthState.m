...
@selector(initWithAuthorizationResponse:tokenResponse:))
...
<NSString * , NSString * > *)additionalHeaders {
                                        ...
                                        callback:^(OIDTokenResponse *_Nullable response,
                                            ...
                                            for (OIDAuthStatePendingAction *actionToProcess in actionsToProcess) {
                                                dispatch_async(actionToProcess.dispatchQueue, ^{
                                                    actionToProcess.action(self.accessToken,
                                                            self.idToken, error);
                                                });
                                            }
                                        }];
