...
- (nonnull instancetype)initWithDiscoveryUrl:(NSString * _Nonnull)discoveryUrl clientId:(NSString * _Nonnull)clientId redirectUrl:(NSString * _Nonnull)redirectUrl scope:(NSArray<NSString *> * _Nonnull)scope postLogoutRedirectURL:(NSString * _Nonnull)postLogoutRedirectURL OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
